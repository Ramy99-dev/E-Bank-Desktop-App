...
public class crediterController {
    ...
    @FXML
    void crediter(ActionEvent event) throws ClassNotFoundException, SQLException, IOException {
    	Database db = new Database();
		Connection conn = db.connect();
    	String query1 =" SELECT maxS from compte where id = ?";
    	Double maxS = null ;
    	...
    	if(newSolde > maxS)
    	{
			...
			alert.setContentText("Le solde du compte "+id +" a dépasser le solde maximale");
